...
router.post('/add', jwt, auth, bookValidators, upload.single('file'), myBookController.addMyBook)

router.get('/change/:id', jwt, auth, myBookController.editMyBookPage)

router.post('/change', jwt, auth,bookValidators, upload.single('file'), myBookController.editMyBook)
